...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    ImageView pageImage;
    Button click;
    public ViewPagerAdapter(FragmentActivity mainActivity, int noofsize) {
 ...
 /*       pagenumber1 = (TextView)layout.findViewById(R.id.pagenumber1);
   ...
   */
        ...
        try {
            if(pagenumberTxt == 1){
                pageImage.setBackgroundResource(R.drawable.b1);
            }
            else if(pagenumberTxt == 2){
                pageImage.setBackgroundResource(R.drawable.b2);
            }else if(pagenumberTxt == 3){
                pageImage.setBackgroundResource(R.drawable.b3);
            }
