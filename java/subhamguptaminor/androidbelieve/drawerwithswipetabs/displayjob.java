...
public class displayjob extends ActionBarActivity {
    ...
    public static ArrayList<WorldPopulation3> arraylist = new ArrayList<WorldPopulation3>();
    public static  String GET_IMAGE_URL1 = "http://hello45.esy.es/bylocation.php";
    ...
    ListView list1;
    ListViewAdapter3 adapter1;
    public GetAllImages4 getAlImages4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_displayjob);
    ...
    private void getImages4(){
        class GetImages extends AsyncTask<Void,Void,Void> {
            ...
            protected void onPostExecute(Void v) {
                ...
                adapter1 = new ListViewAdapter3(displayjob.this, GetAllImages4.arraylist);
        ...
        GetImages getImages4 = new GetImages();
        getImages4.execute();
    }
    ...
    private void getURLs1() {
        class GetURLs extends AsyncTask<String,Void,String>{
            ...
            protected void onPostExecute(String s) {
                ...
                getAlImages4 = new GetAllImages4(s);
                getImages4();
