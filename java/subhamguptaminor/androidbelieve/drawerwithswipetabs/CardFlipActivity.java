...
static Button button9;
    ...
    public class CardFrontFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            list = (ListView) v.findViewById(R.id.listViewApti);
    ...
    public class CardBackFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            v1= inflater.inflate(R.layout.fragment_card_back, container, false);
            buttonans=(Button)v.findViewById(R.id.button6);
                            list1 = (ListView) v1.findViewById(R.id.listViewAns);
    ...
    public void getData(){
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                HttpPost httppost = new HttpPost("http://hello45.esy.es/selectques.php?testno="+testno1);
                Log.i("subham", "get data 1");
    ...
    protected void showList(){
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    CardFlipActivity.this, personList, R.layout.list_quest,
                    new String[]{TAG_QUES},
    ...
    public void getData2(){
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                Log.i("subham", "get data 1");
                DefaultHttpClient httpclient = new DefaultHttpClient(new BasicHttpParams());
                HttpPost httppost = new HttpPost("http://hello45.esy.es/selectans.php?testno="+testno1);
                Log.i("subham", "get data 1");
                // Depends on your web service
                httppost.setHeader("Content-type", "application/json");
